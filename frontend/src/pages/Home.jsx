        ...
        <section className="py-6 bg-blue-50 border-b border-blue-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-blue-800 font-semibold text-lg">
              ...
              {user.role === 'seller' && (
                <Link to="/seller" className="underline hover:text-blue-600">Go to your Seller Dashboard →</Link>
              )}
              {user.role === 'admin' && (
                <Link to="/admin" className="underline hover:text-blue-600">Go to Admin Dashboard →</Link>
              )}
              {user.role === 'buyer' && (
                <Link to="/products" className="underline hover:text-blue-600">Browse Products →</Link>
              )}
            </p>
          </div>
        </section>
